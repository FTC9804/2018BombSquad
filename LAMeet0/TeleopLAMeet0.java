...
@TeleOp(name = "teleop meet 0", group = "GrabbersCombo")
// @Disabled
public class TeleopLAMeet0 extends OpMode {
    ...
    DcMotor rightLift;     //right lift motor
    DcMotor leftLift;      //left lift motor
    ...
    // Bottom
    boolean YBottom = false; // boolean that is initially set to false, and becomes true if the dpad right is pressed
    boolean ABottom = false; // boolean that is initially set to false, and becomes true if the dpad left is pressed
    ...
    public void loop() {
        ...
        if(gamepadleftx > .05 || gamepadleftx < -.05)
        {
            ...
            leftpower = -gamepadleftx/2;
            rightpower = gamepadleftx/2;
        ...
        rightLift.setPower(gamepad1.right_stick_y/2);
        leftLift.setPower(gamepad1.right_stick_y/2);
